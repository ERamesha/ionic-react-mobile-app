import { IonPage, IonRow, IonContent, IonGrid, IonCol, IonFooter, IonImg, IonIcon,IonLabel, IonTabButton, IonButton, IonNavLink } from '@ionic/react';
        ...
        <div id='Homescreen'>
          <IonGrid>
            <IonRow>
              ...
              <IonCol size='12' id='Rectangle147'>
                <div id='title_name'>Kokapet warehouse</div>
              </IonCol>
            </IonRow>
            {/* <IonRow>
            ...
            <IonRow id='Rectangle148'>
              ...
              <IonCol size='6'>
                <div id='viewall1' onClick={() => history.push('/deliverychallan')}>View All</div>
              </IonCol>
            </IonRow>
            <IonRow id='Rectangle153'>
              ...
              <IonCol>
              <div id='viewall1' onClick={() => history.push('/receivingchallan')}>View All</div>
              </IonCol>
            </IonRow>
            <IonRow>
